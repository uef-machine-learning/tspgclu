...
double calculate_recall_sampled(kNNGraph* ground_truth, kNNGraph* kNN, int recall_K) {
    ...
    cost = ((double)g_dist_count)/(((double)(kNN->size - 1))*((double)(kNN->size))/2 ); //TODO: verify if correct (-1) ?
    recall = ((double)recall_count)/(recall_K*ground_truth->size);
...
double calculate_recall(kNNGraph* ground_truth, kNNGraph* kNN, int recall_K) {
...
double calculate_recall(kNNGraph* ground_truth, kNNGraph* kNN) {
...
void calculate_recall(kNNGraph* kNN) {
    ...
    /*else {*/
    /*double time_diff,cost;*/
    /*time_diff = g_timer.get_time();*/
    /*cost = ((double)g_dist_count)/(((double)(kNN->size - 1))*((double)(kNN->size))/2 );  ?*/
